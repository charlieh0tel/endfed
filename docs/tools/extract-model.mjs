...
const EXPORTS = [
  ...
  'lengthPower', 'bugReportUrl', 'BUG_REPORT_URL', 'WIRE_RADIUS_M', 'MODEL_NEC_RUNS', 'MODEL_HOLDOUT_RUNS', 'deckModel', 'NEC_AGREE_FACTOR', 'necSwrText', 'fmtSwr', 'necAgrees', 'nec2cFiction', 'NEC2C_FICTION_FACTOR', 'necRuns',
